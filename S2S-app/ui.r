                   ...
                   tabPanel('NMME Forecasts',
                            div(class = 'outer',
                                ...
                                absolutePanel(id = 'controls', 
									  ...
									  'Month 1 Forecast' = '1',
                                                                          'Month 2 Forecast' = '2',
                                                                          'Season 0 Forecast' = 'season'), 
                                                           selected = '0'
                                              ),
                                              bsPopover(id = "q5", title = "Forecast Period",
                                                        content = "Monthly forecasts are displayed at leads 0, 1, 2, and Season 0. For example, for forecast produced in Oct, Month 0 = Oct, Month 1 = Nov, Month 2 = Dec, and Season 0 = Oct-Dec.",
                                                        placement = "left",
                                                        trigger = "focus",
                                                        options = list(container = "body")
                                              ),
                            ...
                            div(class = 'outer',
                                ...
                                absolutePanel(id = 'controls', 
                                              ...
                                              bsPopover(id = "q12", title = "Forecast Period",
                                                        content = "Monthly forecasts are displayed at leads 1, 2, 3, and Season 1. For example, for forecast produced in Oct, Month 0 = Oct, Month 1 = Nov, Month 2 = Dec, and Season 0 = Oct-Dec.",
                                                        placement = "left",
                                                        trigger = "focus",
                                                        options = list(container = "body")
                                              ),
